...
def get_train_image_seq(args, **kwargs):
    if ('.png' in args.static_style_path or '.jpg' in args.static_style_path or '.jpeg' in args.static_style_path):
        style_img = Image.open(args.static_style_path)
        ...
        train_image_seq_sort = preprocess_video(args.style_path, img_size=(256, 256))
        ...
        train_image_seq_texture = preprocess_video(args.static_style_path, img_size=args.img_size)
